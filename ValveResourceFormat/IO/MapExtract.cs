...
public sealed class MapExtract
{
    ...
    /// template's child entity lump. The clones keep the authored entity's hammeruniqueid,
    /// so they can be collapsed into the single entity the map was authored with.
    /// </summary>

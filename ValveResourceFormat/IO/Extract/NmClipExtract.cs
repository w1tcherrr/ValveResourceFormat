...
public class NmClipExtract
{
    ...
    public ContentFile ToContentFile()
    {
        ...
        var (sourceFileName, additiveBaseFileName) = FindAuthoredSourceFiles(skeletonSourceFiles);
    ...
    /// </summary>
    private (string? SourceFileName, string? AdditiveBaseFileName) FindAuthoredSourceFiles(HashSet<string> skeletonSourceFiles)
    {
        ...
        if (sourceFileName == null || candidates.Count != 2)
        {

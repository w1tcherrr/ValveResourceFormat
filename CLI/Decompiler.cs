...
namespace CLI
{
    public partial class Decompiler
    {
        ...
        /// <param name="gltf_export_lods">Export every level of detail using the MSFT_lod extension, instead of only the highest-detail one.</param>
        ...
        )
        {
            ...
            GltfExportLods = gltf_export_lods;
            ...
            if (!Decompile && (GltfExportFormat != null || GltfExportAnimations || GltfExportMaterials || GltfExportAdaptTextures || GltfExportExtras || GltfExportLods))
            {
